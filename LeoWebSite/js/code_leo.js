 ...
 */
			...
			var defaultInfoWindow="<font face='微軟正黑體', sans-serif size=3><table border=0 class=c>  <tr>    <td colspan=2  align='center'><img src='http://dl.dropbox.com/u/15689886/LeoWebSite/img/DSC01167_s.jpg' width=400px height=300px></td>  </tr>  <tr>    <td align='center'  colspan=2 ><b><font size=3>正哲 &nbsp; <font color=#ff0000 size=3>&amp;</font> &nbsp; 伊珊</font></b><br>      我們要結婚了<br>      衷心邀請您蒞臨<br></td></tr><tr>    <td colspan=2  align='center'  ><font color=#ff0000 size=3>❤結婚</font><br>      2011/11/26(六) 中午12:00<br>      新竹-荷竹園餐廳<br/></td>  </tr></table>";
			...
			//<!---tr>     <td><font color=#ff0000 size=3>❤結婚</font><br>      2011/11/26(六) 中午12:00<br>      新竹 - 荷竹園 </b></td>  </tr-->
		 	var destination="新竹市武陵路";
			var defaultLat=24.820681;
			var defaultLng=120.967601;
			var defaultZoom=12;
								...
								if(response.Status.code==200){
									...
									html="<table borde=0 width=240px>"+
											 "<tr><td><font size=4><b>"+ addresses[addressNum].NAME + "</b></font><hr></td></tr>"+
						 					 ...
						 					 "</table>";
									marker = createMarker(new GLatLng(24.820681, 120.967601), addresses[addressNum].NAME, html, addresses[addressNum].ICON);
			...
			function doDirection(address){
				...
				//alert("from: "+ address + " to: "+ destination)
